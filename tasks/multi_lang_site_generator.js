module.exports = function (grunt) {
    ...
    var projectFiles = {
        'halfwide_index.inc':       'halfwide_index.inc.tmpl', 
        'index.html':               'index.html.tmpl',
        'index.inc':                'index.inc.tmpl',
        'test.html':                'test.html.tmpl',
        'list_halfwide.inc':        'list_halfwide.inc.tmpl', 
        'list.html':                'list.html.tmpl',
        'list.inc':                 'list.inc.tmpl',
        'list_test.html':           'list_test.html.tmpl'
    };
